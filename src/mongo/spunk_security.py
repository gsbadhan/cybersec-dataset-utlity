...
class SplunkSecurity:
    ...
    def create_bulk_record(self, database, collection_name="splunk_content",  delete_collection=False):
        splunk_file = config.OUTPUT.get("splunk_detection_events")
        ...
        records = self.read_json(file_path=splunk_file)
...
if __name__ == "__main__":
    splunk = SplunkSecurity()
    db=splunk.get_or_create_database(db_name="cybersec")
    splunk.create_bulk_record(database=db, delete_collection=True)